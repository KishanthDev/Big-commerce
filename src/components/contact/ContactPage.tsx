            ...
            <div className="max-w-6xl mx-auto px-5">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="md:col-span-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                        ...
                        <form>
                            <div className="mb-6">
                                <label htmlFor="name" className="block font-medium mb-2 text-sm dark:text-gray-400">
                                    Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-6">
                                <label htmlFor="email" className="block font-medium mb-2 text-sm dark:text-gray-400">
                                    Email
                                </label>
                                <input
                                    type="email"
                            ...
                            <div className="mb-6">
                                <label htmlFor="subject" className="block font-medium mb-2 text-sm dark:text-gray-400">
                                    Subject
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-6">
                                <label htmlFor="message" className="block font-medium mb-2 text-sm dark:text-gray-400">
                                    Message
                                </label>
                                <textarea
                                    id="message"
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                        ...
                        <div className="flex items-start mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm dark:text-gray-400">support@markethub.com</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm dark:text-gray-400">(555) 123-4567</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm dark:text-gray-400">Monday - Friday: 9AM - 5PM EST</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm dark:text-gray-400">Follow us @MarketHub</p>
                            </div>
                        </div>
                    </div>
                </div>
