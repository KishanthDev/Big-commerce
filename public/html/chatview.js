document.addEventListener("DOMContentLoaded", () => {
  ...
  const chatBarTextColorInput = document.getElementById(
    "chatBarTextColorInput",
  );
  const chatBarTextColorText = document.getElementById("chatBarTextColorText");

  // Chat Widget Inputs
  const widgetBotMsgBgColorInput = document.getElementById(
    "widgetBotMsgBgColorInput",
  );
  const widgetBotMsgBgColorText = document.getElementById(
    "widgetBotMsgBgColorText",
  );
  const widgetUserMsgBgColorInput = document.getElementById(
    "widgetUserMsgBgColorInput",
  );
  const widgetUserMsgBgColorText = document.getElementById(
    "widgetUserMsgBgColorText",
  );
  const widgetSendBtnBgColorInput = document.getElementById(
    "widgetSendBtnBgColorInput",
  );
  const widgetSendBtnBgColorText = document.getElementById(
    "widgetSendBtnBgColorText",
  );
  const widgetSendBtnIconColorInput = document.getElementById(
    "widgetSendBtnIconColorInput",
  );
  const widgetSendBtnIconColorText = document.getElementById(
    "widgetSendBtnIconColorText",
  );
  ...
  const chatPreviewTextColorInput = document.getElementById(
    "chatPreviewTextColorInput",
  );
  const chatPreviewTextColorText = document.getElementById(
    "chatPreviewTextColorText",
  );
  ...
  const chatNowBtnTextColorInput = document.getElementById(
    "chatNowBtnTextColorInput",
  );
  const chatNowBtnTextColorText = document.getElementById(
    "chatNowBtnTextColorText",
  );
  const linkItemBgInput = document.getElementById("linkItemBgInput");
  const linkItemBgText = document.getElementById("linkItemBgText");
  const linkItemTextColorInput = document.getElementById(
    "linkItemTextColorInput",
  );
  const linkItemTextColorText = document.getElementById(
    "linkItemTextColorText",
  );
  ...
  const footerButtonsIconColorInput = document.getElementById(
    "footerButtonsIconColorInput",
  );
  const footerButtonsIconColorText = document.getElementById(
    "footerButtonsIconColorText",
  );
  ...
  const eyecatcherPreviewTitle = document.getElementById(
    "eyecatcherPreviewTitle",
  );
  const eyecatcherPreviewText = document.getElementById(
    "eyecatcherPreviewText",
  );
  ...
  const widgetMessagesPreview = document.getElementById(
    "widgetMessagesPreview",
  );
  ...
  const chatWidgetLandingInputs = document.getElementById(
    "chatWidgetLandingInputs",
  );
  const chatWidgetOpenContent = document.getElementById(
  ...
  function sendMessage() {
    ...
    if (widgetUserMsgBgColorText) {
      messageDiv.querySelector("div").style.backgroundColor =
        widgetUserMsgBgColorText.value;
    }
  ...
  function handleRadioChange() {
    const selectedOption = document.querySelector(
      'input[name="chat_option"]:checked',
    ).value;
      ...
      if (savedSettings) {
        ...
        if (settings.selectedOption) {
          const radioToCheck = document.querySelector(
            `input[name="chat_option"][value="${settings.selectedOption}"]`,
          );
          if (radioToCheck) {
        ...
        if (eyecatcherPreviewTitle)
          eyecatcherPreviewTitle.textContent = titleInput.value || "Hello";
        if (eyecatcherPreviewText)
          eyecatcherPreviewText.textContent =
            textInput.value || "Click to chat";
        if (eyecatcherPreviewBox)
        ...
        if (chatBarPreviewText)
          chatBarPreviewText.textContent =
            chatBarTextInput.value || "Chat with us";
        if (chatBarPreviewBox)
        ...
        if (widgetBotMsgBgColorText)
          widgetBotMsgBgColorText.value =
            settings.chatWidget.botMsgBgColor || "#f3f4f6";
        if (widgetUserMsgBgColorText)
          widgetUserMsgBgColorText.value =
            settings.chatWidget.userMsgBgColor || "#fef08a";
        if (widgetSendBtnBgColorText)
          widgetSendBtnBgColorText.value =
            settings.chatWidget.sendBtnBgColor || "#000000";
        if (widgetSendBtnIconColorText)
          widgetSendBtnIconColorText.value =
            settings.chatWidget.sendBtnIconColor || "#ffffff";
        if (footerBgColorText)
          footerBgColorText.value =
            settings.chatWidget.footerBgColor || "#ffffff";
        if (footerTextColorText)
          footerTextColorText.value =
            settings.chatWidget.footerTextColor || "#374151";
        if (modalBgColorText)
          modalBgColorText.value =
            settings.chatWidget.modalBgColor || "#d3d3d3";
        if (modalTitleColorText)
          modalTitleColorText.value =
            settings.chatWidget.modalTitleColor || "#000000";
        if (chatPreviewBgText)
          chatPreviewBgText.value =
            settings.chatWidget.chatPreviewBg || "#f3f4f6";
        if (chatPreviewTextColorText)
          chatPreviewTextColorText.value =
            settings.chatWidget.chatPreviewTextColor || "#374151";
        if (chatNowBtnBgText)
          chatNowBtnBgText.value =
            settings.chatWidget.chatNowBtnBg || "#000000";
        if (chatNowBtnTextColorText)
          chatNowBtnTextColorText.value =
            settings.chatWidget.chatNowBtnTextColor || "#ffffff";
        if (linkItemBgText)
          linkItemBgText.value = settings.chatWidget.linkItemBg || "#f3f4f6";
        if (linkItemTextColorText)
          linkItemTextColorText.value =
            settings.chatWidget.linkItemTextColor || "#374151";
        if (footerBoxBgText)
          footerBoxBgText.value = settings.chatWidget.footerBoxBg || "#ffffff";
        if (footerButtonsBgText)
          footerButtonsBgText.value =
            settings.chatWidget.footerButtonsBg || "#f3f4f6";
        if (footerButtonsIconColorText)
          footerButtonsIconColorText.value =
            settings.chatWidget.footerButtonsIconColor || "#374151";
  ...
  function updatePreviewElements() {
    // Update Eyecatcher
    if (eyecatcherPreviewTitle && titleInput)
      eyecatcherPreviewTitle.textContent = titleInput.value || "Hello";
    if (eyecatcherPreviewText && textInput)
      eyecatcherPreviewText.textContent = textInput.value || "Click to chat";
    if (eyecatcherPreviewBox && bgColorInput)
      eyecatcherPreviewBox.style.backgroundColor = bgColorInput.value;
    if (eyecatcherPreviewBox && textColorInput)
      eyecatcherPreviewBox.style.color = textColorInput.value;

    // Update Bubble
    if (bubblePreviewBox && bubbleBgColorText)
      bubblePreviewBox.style.backgroundColor = bubbleBgColorText.value;
    ...
    // Update Chat Bar
    if (chatBarPreviewText && chatBarTextInput)
      chatBarPreviewText.textContent = chatBarTextInput.value || "Chat with us";
    if (chatBarPreviewBox && chatBarBgColorText)
      chatBarPreviewBox.style.backgroundColor = chatBarBgColorText.value;
    if (chatBarPreviewBox && chatBarTextColorText)
      chatBarPreviewBox.style.color = chatBarTextColorText.value;

    // Update Chat Widget
    if (widgetMessagesPreview && widgetBotMsgBgColorText) {
      widgetMessagesPreview
        .querySelectorAll(".chat-message:not(.user) > div")
        .forEach((div) => {
    ...
    if (widgetMessagesPreview && widgetUserMsgBgColorText) {
      widgetMessagesPreview
        .querySelectorAll(".chat-message.user > div")
        .forEach((div) => {
  ...
  function saveSettings() {
    try {
      const settings = {
        selectedOption:
          document.querySelector('input[name="chat_option"]:checked')?.value ||
          "eyecatcher",
        eyecatcher: {
        ...
        chatWidget: {
          ...
          footerButtonsIconColor:
            footerButtonsIconColorText?.value || "#374151",
        },
      };
  ...
  function setupInputListeners() {
    ...
    if (widgetSendBtnBgColorInput) {
      widgetSendBtnBgColorInput.addEventListener("input", () => {
        ...
        widgetSendButton.style.backgroundColor =
          widgetSendBtnBgColorInput.value;
      });
    }
    if (widgetSendBtnIconColorText) {
