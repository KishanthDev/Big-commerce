...
describe('HowItWorks Component', () => {
  ...
  test('has proper accessibility attributes', () => {
    render(<HowItWorks />);
    expect(screen.getByRole('heading', { level: 2 })).toHaveTextContent('How It Works: 3 Simple Steps');
    expect(screen.getAllByRole('heading', { level: 3 })).toHaveLength(mockSteps.length);
  });
});