  ...
  const steps = [
    {
      ...
      title: "Sign Up",
      description:
        "Create your free account in minutes.Allyou need is basic information to get started.",
    },
    {
      number: "2",
      title: "Upload Products",
      description:
        "Add your inventory with photos ,description and pricing.User-friendly dashboard makes this way.",
    },
    {
      number: "3",
      title: "Start Selling",
      description:
        "Begin recieving orders from local customers.Mange everything from your personalised dashboard",
    },
  ];
