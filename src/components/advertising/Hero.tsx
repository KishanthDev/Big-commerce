        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base sm:text-lg text-primary opacity-90 mb-6 max-w-lg mx-auto md:mx-0">
              Get noticed with our affordable advertising options. Reach active
              shoppers looking for products like yours and increase your store's
              visibility on MarketHub.
            </p>
            <Button
              variant="outline"
            ...
            >
              Advertise Today{" "}
              <ArrowRight data-testid="hero-icon" className="w-4 h-4 ml-2" />
            </Button>
          </div>
