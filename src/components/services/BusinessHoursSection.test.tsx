...
describe("BusinessHoursSection", () => {
  ...
  test("renders the component with title", () => {
    ...
    expect(
      screen.getByRole("heading", { level: 2, name: "Business Hours" }),
    ).toBeInTheDocument();
  });
  ...
  test("renders the emergency towing notice", () => {
    ...
    expect(
      screen.getByText("24/7 Emergency Towing Available"),
    ).toBeInTheDocument();
    expect(screen.getByText("24/7 Emergency Towing Available")).toHaveClass(
      "text-red-600",
    );
  });
